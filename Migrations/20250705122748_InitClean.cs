        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PedidoId = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PedidoId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ClienteId = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenuPizzas", x => new { x.MenusId, x.PizzasId });
                    table.ForeignKey(
                        name: "FK_MenuPizzas_Menus_MenusId",
                        column: x => x.MenusId,
                        principalTable: "Menus",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MenuPizzas_Pizzas_PizzasId",
                        column: x => x.PizzasId,
                        principalTable: "Pizzas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RNCEmpleado = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenuProductos", x => new { x.MenusId, x.ProductosId });
                    table.ForeignKey(
                        name: "FK_MenuProductos_Menus_MenusId",
                        column: x => x.MenusId,
                        principalTable: "Menus",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MenuProductos_Productos_ProductosId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PedidoDetalles_Facturas_FacturaId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductoIngredientes", x => new { x.IngredientesId, x.ProductosId });
                    table.ForeignKey(
                        name: "FK_ProductoIngredientes_Ingredientes_IngredientesId",
                        column: x => x.IngredientesId,
                        principalTable: "Ingredientes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductoIngredientes_Productos_ProductosId",
                        column: x => x.ProductosId,
                        principalTable: "Productos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuPizzas_PizzasId",
                table: "MenuPizzas",
                column: "PizzasId");

            migrationBuilder.CreateIndex(
                name: "IX_MenuProductos_ProductosId",
                table: "MenuProductos",
                column: "ProductosId");

            migrationBuilder.CreateIndex(
                name: "IX_PedidoDetalles_FacturaId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PedidoDetalles_PizzaId",
                table: "PedidoDetalles",
                column: "PizzaId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductoIngredientes_ProductosId",
